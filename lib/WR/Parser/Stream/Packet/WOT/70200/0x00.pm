package WR::Parser::Stream::Packet::WOT::70200::0x00;
use Mojo::Base 'WR::Parser::Stream::Packet::WOT::default::0x00';
...
sub BUILD {
    ...
    $self->enable($_) for(qw/player_id player_name player_name_length arena_unique_id arena_type_id gameplay_id map_id bonus_type gui_type/);
    # battle_level opponents payload_pickle
