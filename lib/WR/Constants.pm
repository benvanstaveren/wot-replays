...
use constant ARENA_PERIOD_BATTLE => 3;

our @EXPORT = ();
our @CONSTANT_VALUES = (qw/NATION_NAMES NATION_INDICES VEHICLE_DEVICE_TYPE_NAMES VEHICLE_TANKMAN_TYPE_NAMES ARENA_UPDATE ARENA_UPDATE_IDX ARENA_PERIOD_BATTLE/);
